...
<?php $__env->startSection('title', 'Add New Movie'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="release_date" name="release_date" value="<?php echo e(old('release_date')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="rating" name="rating" required>
                                        ...
                                        <option value="G" <?php echo e(old('rating') == 'G' ? 'selected' : ''); ?>>G - General Audiences</option>
                                        <option value="PG" <?php echo e(old('rating') == 'PG' ? 'selected' : ''); ?>>PG - Parental Guidance</option>
                                        <option value="PG-13" <?php echo e(old('rating') == 'PG-13' ? 'selected' : ''); ?>>PG-13 - Parents Strongly Cautioned</option>
                                        <option value="R" <?php echo e(old('rating') == 'R' ? 'selected' : ''); ?>>R - Restricted</option>
                                        <option value="NC-17" <?php echo e(old('rating') == 'NC-17' ? 'selected' : ''); ?>>NC-17 - Adults Only</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" id="status" name="status" required>
                                        <option value="now_showing" <?php echo e(old('status') == 'now_showing' ? 'selected' : ''); ?>>Now Showing</option>
                                        <option value="coming_soon" <?php echo e(old('status') == 'coming_soon' ? 'selected' : ''); ?>>Coming Soon</option>
                                        <option value="ended" <?php echo e(old('status') == 'ended' ? 'selected' : ''); ?>>Ended</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="poster_url" name="poster_url" value="<?php echo e(old('poster_url')); ?>" 
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\si_bioskop\resources\views/admin/movies/create.blade.php ENDPATH**/ ?>